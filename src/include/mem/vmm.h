...
//
// vmm.h for SimpleXX/SimpleKernel.
...
#define VMM_PAGES_PRE_PAGE_DIRECTORY                                           \
...
#define VMM_PAGE_DIRECTORY_SIZE                                                \
    ((uint64_t)VMM_PAGE_TABLES_PRE_PAGE_DIRECTORY *                            \
     (uint64_t)VMM_PAGE_TABLE_SIZE)
